...
document.getElementById('login-viewer').onclick = () => {
startLogin('user-read-playback-state');
};




document.getElementById('login-manager').onclick = () => {
startLogin('user-read-playback-state user-modify-playback-state');
};